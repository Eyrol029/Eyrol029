...
💻 I am a 3rd Year Information Technology student with hands-on experience in full-stack development using Java Spring, MySQL, Vue.js, Tailwind CSS, and other modern web technologies. I enjoy building simple, responsive, and user-friendly web applications while continuously improving my skills in both front-end and back-end development. I am currently working on our capstone project for Tating's Birthing Home and Family Clinic, where we develop a system to help improve their daily operations. I am also currently building a mobile game and simulation using Unity and C# programming language. I am eager to learn more, gain real-world experience, and contribute to meaningful IT projects.

📘 Education Bachelor of Science in Information Technology (BSIT) Mindanao State University – Naawan Present (3rd Year Student)
